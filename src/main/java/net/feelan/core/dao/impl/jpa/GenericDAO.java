...
import net.feelan.core.dao.IGenericDAO;
import net.feelan.core.dao.exception.DAOException;
import net.feelan.core.dao.exception.ObjectNotFoundException;
...
public abstract class GenericDAO<T extends IEntity> implements IGenericDAO<T> {
    ...
    /*
     * (non-Javadoc)
     * @see com.fx.dao.IGenericDAO#list()
     */
    public List<T> list() {
        try {
            return this.getEntityManager().createQuery("select t from " + clz.getName() + " t ").getResultList();
    ...
    /*
     * (non-Javadoc)
     * @see com.fx.dao.IGenericDAO#load(java.io.Serializable)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.fx.dao.IGenericDAO#create(java.lang.Object)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.fx.dao.IGenericDAO#update(java.lang.Object)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.fx.dao.IGenericDAO#delete(java.lang.Object)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.fx.dao.IGenericDAO#list(com.fx.support.Paginator)
     */
    ...
    */
     ...
     */
    protected void applyNamedParameterToQuery(javax.persistence.Query query, String paraName, Object value)
